...
CHECK1_ROWS = [
    ("observed_delta", "0.225", "0.095", "0.885", "1600", None),
...
SIG_ROWS = [
    ("observed_delta", "hallmark", "0.088", "-0.063", "-0.033", "0.855", "0.579", "0.979", None),
    ("observed_delta", "proliferation", "0.097", "-0.016", "-0.035", "0.585", "0.547", "0.884", None),
...
LADDER_ROWS = [
    ...
    ("observed_delta", "0.628 / -0.095", "0.603 / -0.159", "0.601 / -0.155", "-0.149", "0.997", "0.264", "0.091", None),
