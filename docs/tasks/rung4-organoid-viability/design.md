...
**Parent** [`docs/PROJECT_SPEC.md`](../../PROJECT_SPEC.md); **state** [`docs/PROJECT_STATE.md`](../../PROJECT_STATE.md) §1, rung 4.
...
Next action, verbatim in `docs/PROJECT_STATE.md` §1: rebuild the crosswalk with `--refresh`, verify the `source` column, commit, push, pull to Alpine, resubmit `12_sarcoma_organoids_2024_score.sbatch`.
