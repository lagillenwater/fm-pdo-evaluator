...
Every task owns one directory, `docs/tasks/<task-slug>/`, named for what the task does (`rung1-controls-and-capacity`, `embargo-gate-cell-values`) with no date prefix.
