...
**As of** 2026-08-27, commit `6b56478`, branch `worktree-modular-harness-core`.

A number not listed here as promoted is not evidence.
...
|---|---|---|---|
| 0 — replicate ceiling | A reproducibility ceiling clearing its null, on the declared panel | **Measured, not closed** | [`rung0_delta_reproducibility.csv`](results/rung0_delta_reproducibility.csv) · job 31676846 |
| 1 — held-out line | Prediction beating a floor and recovering a planted signal, as a fraction of rung 0 | **Measured, not closed** | [`rung1_check1_fidelity.csv`](results/rung1_check1_fidelity.csv) · job 31675161 |
| 2 — cross-platform | Retention separable from a scrambled-line control | **Measured, not closed** | [`rung2_grid.csv`](results/rung2_grid.csv), [`rung2_transfer_penalty.csv`](results/rung2_transfer_penalty.csv) · jobs 31677382-4 |
| 3 — GDSC2 viability | Interaction above zero after correction, against the screen-agreement ceiling | **Measured, not closed** | [`rung3_check2_grid.csv`](results/rung3_check2_grid.csv), [`rung3_declared_variants.csv`](results/rung3_declared_variants.csv) · job 31665927 |
